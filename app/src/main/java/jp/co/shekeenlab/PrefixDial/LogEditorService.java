...
public class LogEditorService extends Service{
	...
	private void removePrefixFromHistory(){
		...
		if(VERSION.SDK_INT >= VERSION_CODES.M){
			result = getPackageManager().checkPermission(permission.READ_CALL_LOG, getPackageName());
			if(result == PackageManager.PERMISSION_GRANTED){
				result = getPackageManager().checkPermission(permission.WRITE_CALL_LOG, getPackageName());
			}
		}
